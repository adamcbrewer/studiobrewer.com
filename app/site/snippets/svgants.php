<?php if (isset($type)) : ?>
    ...
    <?php if ($type == 'twitter') : ?>
        ...
        <svg class="svg-ants svg-ants--octogon animate-reverse" preserveAspectRatio="xMidYMid" width="240" viewBox="0 0 277.2 277.2">
            <path stroke-width="4" stroke-miterlimit="10" d="M231.2 37.5L132.7 1.6 37.5 46 1.6 144.5 46 239.8l98.5 35.8 95.3-44.4 35.8-98.5z"/>
        </svg>

    <?php elseif ($type == 'dribble') : ?>
