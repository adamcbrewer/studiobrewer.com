<p>
    ...
    <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode($page->url()) ?>&amp;description=<?php echo urlencode($page->title()) ?>&amp;media=<?php echo urlencode($page->first_image()->url()); ?>">Pinterest</a>
</p>
