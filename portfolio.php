...
$portfolio = array(
	'projects' => array(
		...
		array(
			...
			// the project details
			'description' => "It's been said that often on Halloween, the Zombie Ale bottles reveal themselves from the darkest depths to force-feed their devilish ale to innocent folk. After consumption, they become Party Zombies who are only alive until dawn, and they make the night count.<br /><br />Created as a simple e-mailer sent round to haunt inboxes.<br /><br />–<br />Illustration<br />",
	...
	'profile' => array(
		'about' => array(
			'title' => 'About',
			'heroCopy' => 'Studio Brewer is the creative practice of Jake Brewer, a South African Designer, Art Director and Illustrator based in London with many years of experience.<br /><br />Believing in strong ideas without boundaries, formulas or specific tools, I remain dedicated to creating beautifully executed and carefully considered work.<br /><br />Working in a visual style that suits the needs of the project, I enjoy adapting and moving freely between different types of media and creative fields.<br /><br />From concept through to art direction and design, I love every part of the process.',
			'introCopy' => 'Studio Brewer is the creative practice of Jake Brewer, a South African Designer, Art Director and Illustrator based in London with many years of experience.'
		),
		'what' => array(
			'title' => 'What I do',
			'items' => array(
